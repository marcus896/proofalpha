...
All notable changes to ProofAlpha are documented here.

## Unreleased

### Added

- Public packaging for the research and paper-execution engine.
- ProofAlpha console command and brand assets.
...
- Distribution version prepared as `0.1.0`.
...
- Full published test suite.
- Release doctor and targeted static checks.
