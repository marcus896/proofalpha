...
- paper and no-key operation by default;
- reproducible inputs and immutable evidence artifacts;
- chronological and stress-based validation before promotion;
- explicit costs, execution assumptions, and limitations;
